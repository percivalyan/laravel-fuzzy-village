...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary">Form Tambah Harga</h6>
        </div>
        <div class="card-body">
            <form action="{{ route('harga.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="harga_per_hektar" id="harga_per_hektar" class="form-control" required>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="luas_per_hektar" id="luas_per_hektar" class="form-control" required>
